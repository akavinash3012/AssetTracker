	...
	<div class="container-fluid index-container-custom slider-content">
		...
		<div class="row text-center request">
			<div class="col-md-12 request-form">
				...
				<div class="reqHeader">ENTER ASSET LOCATION</div>
					
						<form action="VenderServlet" method="post" id="demo_form" class="form-horizontal">
                        ...
                        <div class="row">
                           ...
                           <div class="row">
							<div class="col-md-4 col-sm-6 col-centered">
								<input type="text" class="form-text form-control top-buffer"
									 name="locationID" placeholder="Location ID" />
                        ...
                        <div class="row">
                          ...
                          <div class="row">
							<div class="col-md-4 col-sm-6 col-centered">
								<input type="datetime-local" class="form-text form-control top-buffer"
...
String sql ="select * from assetlocation";
