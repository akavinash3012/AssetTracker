	...
	<div class="container-fluid index-container-custom slider-content">
		...
		<div class="row text-center request">
			<div class="col-md-12 request-form">
				<div class="reqHeader">ADD USER</div>
					...
					<FORM NAME="RegUser" ACTION="AddUserServlet" method="post" id="demo_form" class="form-horizontal">
                        ...
                        <div class="col-md-3 col-sm-6 col-centered">
								<input type="text" class="form-text form-control top-buffer"
									 name="Organization" placeholder="Organisation" />
							</div>
                        </div>
                          <div class="row">
                        <div class="col-md-3 col-sm-6 col-centered">
								<input type="text" name="ContactNumber" class="form-text form-control top-buffer"
									placeholder="Contact" />
							</div>
                        </div>
                           <div class="row ">
